#!/usr/bin/env python3
"""
Token Vector Animator (full rewritten backend)
...
- GET  /groups            -> list groups (persistent)
...
def tokenize_endpoint():
    ...
    This endpoint is used for both full/manual tokenization and chunked realtime chunks.
    """
